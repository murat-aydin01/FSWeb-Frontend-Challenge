...
function Header() {
  ...
  return (
    <header className="h-[150px] lg:h-[200px] w-full justify-between flex flex-col items-center lg:items-end">
      <div className="md:w-[480px] h-[50px] flex justify-center lg:justify-end items-center lg:mt-[30px]">
        <Mode />
      </div>
      <div className="w-full h-[50px] lg:h-[80px] flex justify-center items-center">
        ...
        <nav className="h-full w-[522px] flex justify-between items-center text-acik font-medium text-[18px]">
          ...
          <a href="https://www.linkedin.com/in/murat-aydin-1394b51ba" className="px-5 py-2 border-2 border-acik-mor rounded-lg text-acik-mor dark:bg-white font-medium">
            {header.hireMe}
          </a>
        </nav>
      </div>
